          ...
          <div class="wrapper-box">
            <div class="left-content">
              <ul class="contact-info">
                <li><span class="flaticon-mail"></span><a href="mailto:info@badri.org">info@badri.org</a></li>
                <li><span class="flaticon-phone"></span><a href="tel:+9911999544">+91-9911999544 ,</a> <a href="tel:+91 7982327579">+91-7982327579</a></li>
              </ul>
            </div>
                  ...
                  <nav class="main-menu navbar-expand-xl navbar-dark">
                    ...
                    <div class="collapse navbar-collapse">
                      <ul class="navigation">
                        ...
                        <li class="dropdown"><a href="#">News Rooms</a>
                        </li>
                        <li><a href="#">Media</a></li>
                        <li><a href="#">Get Involed</a></li>
                        <li><a href="#">Contribute Material</a></li>
                        <li><a href="#">Shop</a></li>
